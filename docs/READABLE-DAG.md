...
| `Readable.PromiseState` | `Readable/State.lean` | first-order view of promise outcomes, not ECMAScript promise objects | `foreignBoundary` objects; owned settlement transition projection; STREAMCLOSE, STREAMERROR | representation |
